...
To check if users have access to an application:
...
5. To perform a detailed test on a single user, select **Testing a single user** and enter their email address. The test results will show:
